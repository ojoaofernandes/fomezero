...
class PlatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plate" do
    assert_difference('Plate.count') do
      post plates_url, params: { plate: { description: @plate.description, prepare_time: @plate.prepare_time, price: @plate.price } }
    end
  ...
  test "should update plate" do
    patch plate_url(@plate), params: { plate: { description: @plate.description, prepare_time: @plate.prepare_time, price: @plate.price } }
